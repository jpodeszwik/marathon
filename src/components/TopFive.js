...
const TopFive =(props)=>{
    let results = props.rank.length > 1 ? props.rank.sort((a, b) =>{return a.content.totalFights < b.content.totalFights ? 1 : a.content.totalFights > b.content.totalFights ? -1 : 0}) :
